...
class Personalinfo1
{
    ...
    Personalinfo1()
    {
        ...
        myframe.getContentPane().setBackground(Color.PINK);  //getContentPane used get color for one layer
    ...
    /*public void actionPerformed(ActionEvent ae)
    {
         ...
         if(ae.getSource()==btn_login)   
        {
            ...
            String add=lbl_text1.getText();
            if(user.equalsIgnoreCase("Samruddhi") && add.equals("Sangamner"))
            {
            ...
            if(lbl_text.getText().equals(" "))
            {
                JOptionPane.showMessageDialog(null, "should not empty");
            }
            else
            {
